  ...
  return (
    <div className='sm:shadow-sm sm:hover:shadow-slate-400 transition-shadow p-4 my-4 rounded-md group '>
        <Link href={`/movie/${props.movie.id}`}>
            <Image width={200} height={300} placeholder='blur' blurDataURL='/spinner.svg' className='w-[80%] mx-auto group-hover:opacity-80 transition-opacity duration-200' src={`https://image.tmdb.org/t/p/original/${props.movie.poster_path}`}></Image>
